...
retrosmart-icon-theme/scalable/brightnesssettings.svg: retrosmart-icon-theme/index.theme
	cd retrosmart-icon-theme/scalable && ln -s display-brightness.svg brightnesssettings.svg
...
retrosmart-icon-theme/scalable/mixer.svg: retrosmart-icon-theme/index.theme
	cd retrosmart-icon-theme/scalable && ln -s multimedia-volume-control.svg mixer.svg
...
retrosmart-icon-theme/scalable/start-here-lxqt.svg: retrosmart-icon-theme/index.theme
	cp src/start-here-lxqt.svg retrosmart-icon-theme/scalable/start-here-lxqt.svg
